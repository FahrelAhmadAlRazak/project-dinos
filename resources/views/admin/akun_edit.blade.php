...
<main class="flex">
    <div id="sidebar" class="bg-admin-secondary hidden sm:flex flex-col gap-5 lg:w-1/6 pt-28 h-screen">
        ...
        <hr>
        <a href="/test/pages/admin/dashboard.html" class="flex items-center gap-3 px-8">
        ...
        <div class="my-2 px-8 pt-6 pb-4 shadow w-full h-full overflow-y-scroll">
            ...
            <table class="border w-full">
                <tr>
                    ...
                    <td>
                        <input type="text" name="nama" id="nama" class="w-full  bg-transparent" value="Admin">
                    </td>
                </tr>
                <tr class="bg-slate-200">
                    <td class="w-1/3 px-4 py-3">Username</td>
                    <td>
                        <input type="text" name="username" id="username" class="w-full  bg-transparent" value="adm1">
                    </td>
                </tr>
                <tr>
                    <td class="w-1/3 px-4 py-3">Email</td>
                    <td>
                        <input type="email" name="email" id="email" class="w-full  bg-transparent" value="admin@mail.com">
                    </td>
                </tr>
                <tr class="bg-slate-200">
                    <td class="w-1/3 px-4 py-3">Password</td>
                    <td>
                        <input type="password" name="password" id="password" class="w-full  bg-transparent" value="admin123">
                    </td>
                </tr>
                <tr>
                    <td class="w-1/3 px-4 py-3">No Identitas</td>
                    <td>
                        <input type="text" name="noIdentitas" id="noIdentitas" class="w-full  bg-transparent" value="212410101000">
                    </td>
                </tr>
                <tr class="bg-slate-200">
                    <td class="w-1/3 px-4 py-3">Alamat</td>
                    <td>
                        <input type="text" name="alamat" id="alamat" class="w-full  bg-transparent" value="Jl. Sumatera">
                    </td>
                </tr>
                <tr>
                    <td class="w-1/3 px-4 py-3">No Telepon</td>
                    <td>
                        <input type="tel" name="noTelepon" id="noTelepon" class="w-full  bg-transparent" value="082345678901">
                    </td>
                </tr>
                <tr class="bg-slate-200">
                    <td class="w-1/3 px-4 py-3">Tanggal Lahir</td>
                    <td>
                        <input type="date" name="tanggalLahir" id="tanggalLahir" class="w-full  bg-transparent" value="2000-01-01">
                    </td>
                </tr>
            </table>
            <div class="mt-8 flex flex-col xs:items-center sm:flex-row sm:justify-between sm:items-start">
                ...
                <div class="flex gap-4 sm:w-1/3">
                    <a href="{{ route('akun_admin') }}" class="w-1/2 bg-admin-secondary hover:opacity-90 py-1 rounded-full text-white text-center">Kembali</a>
    ...
    <div id="passwordModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="bg-white relative px-8 py-6 w-1/3 max-w-2xl max-h-full flex flex-col items-center">
            ...
            <input type="text" placeholder="Password" class="px-4 border border-slate-50 w-full rounded shadow-md" name="passwordModalValue" id="passwordModalValue">
...
<script>
    ...
    $("#simpanData").click(()=>{
        ...
        setTimeout(()=>{
            window.location.replace("/test/pages/admin/akun.html");
        }, 1000);
    })
</script>
</body>
