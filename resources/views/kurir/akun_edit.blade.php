...
<html>
  ...
  <body class="relative">
    <header
      class="bg-kurir-primary flex justify-between items-center absolute px-6 py-3 w-screen h-24"
    >
    ...
    <main class="flex">
      <div
        id="sidebar"
        class="bg-kurir-secondary hidden sm:flex flex-col gap-5 lg:w-1/6 pt-28 h-screen"
      >
        ...
        <hr />
        <a
          href="/test/pages/kurir/dashboard.html"
        ...
        <a
          href="/test/pages/kurir/akun.html"
          class="flex items-center gap-3 px-8"
        >
    ...
    <script>
      ...
      $("#simpanData").click(() => {
        ...
        setTimeout(() => {
          window.location.replace("/test/pages/kurir/akun.html");
        }, 1000);
      });
    </script>
  </body>
