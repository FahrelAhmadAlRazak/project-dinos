...
<html>
  ...
  <body class="relative">
        ...
        <div class="my-2 px-8 pt-6 pb-4 shadow w-full h-full overflow-y-scroll">
          ...
          <div class="mt-8 flex justify-end">
            <div class="flex gap-4 w-1/3">
              <a
                href="{{ route('akun_edit_mitra') }}"
                class="w-1/2 bg-admin-secondary hover:opacity-90 py-1 rounded-full text-white text-center"
                >Edit</a
              >
              <button
                class="w-1/2 bg-admin-secondary hover:opacity-90 py-1 rounded-full text-white flex justify-center items-center gap-1"
                id="logoutBtn"
              >
                <img class="w-5" src="images/logout.svg" alt="" />Logout
              </button>
            </div>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          <div class="flex gap-4 w-2/3">
            <button class="w-1/2 bg-green-700 text-white py-2" id="iyaLogout">
              Iya
            </button>
            <button class="w-1/2 bg-red-700 text-white py-2" id="noLogout">
              Tidak
            </button>
          </div>
        </div>
    ...
    <script>
      ...
      $("#iyaLogout").click(() => {
        window.location.replace("/test/pages/mitra/dashboard.html");
      });
      $("#logoutBtn").click(() => {
        _logoutModal.toggle();
      });
