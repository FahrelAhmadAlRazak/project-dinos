...
<body class="relative">
<header class="bg-mitra-primary flex justify-between items-center absolute px-6 py-3 w-screen h-24">
    <img src="images/logo.png" class="h-16" alt="">
    <img src="images/user.svg" class="h-12" alt="">
</header>
<main class="flex">
    <div id="sidebar" class="bg-mitra-secondary hidden sm:flex flex-col gap-5 lg:w-1/6 pt-28 h-screen">
        <div class="flex items-center gap-3 mx-4">
            <img src="images/user.svg" class="h-12" alt="">
            <p class="text-white hidden lg:block">Mitra</p>
        </div>
        <hr>
        <a href="{{ route('dashboard_mitra') }}" class="flex items-center gap-3 px-8">
            <img src="images/home_active.svg" class="w-5" alt="">
            <p class="text-yellow hidden lg:block">Dashboard</p>
        </a>
        <a href="{{ route('akun_mitra') }}" class="flex items-center gap-3 px-8">
